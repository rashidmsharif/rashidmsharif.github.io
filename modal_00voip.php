...
$text  = "Our voice services are aimed at making both small and
...
<div id="services-voip" class="modal fade" style="margin-top: 25px;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2">
				...
				<div class="modal-content">
						<div class="modal-header">
			      		...
			      		<div class="modal-body">
							...
							<img style="width:100px" src="images/small/voip.jpg"></div>		
			...
			?>
					...
					<tr style='border-bottom:1px dotted gray'>
						...
						<div style="clear:both"></div> 
										...
										<a href="services_voip" style='text-decoration:none; width: 120px; margin-right: 20px; float:left; margin-top: 16px; padding-top: 5px; border: 1px solid #c7c6c6' class='button-hf' >
