...
$title = 'Mobile Apps and Software Development';



	
$text  = "	
Our software and mobile apps development services include:<br/> 	
...
<div id="services-apps" class="modal fade" style="margin-top: 25px;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2">
				...
				<div class="modal-content">
						<div class="modal-header">
			      		...
			      		<div class="modal-body">
							...
							<img style="width:100px" src="images/small/softwares.jpg"></div>		
			...
			?>
					...
					<tr style='border-bottom:1px dotted gray'>
						...
						<div style="clear:both"></div> 
										...
										<a href="services_software" style='text-decoration:none; width: 120px; margin-right: 20px; float:left; margin-top: 16px; padding-top: 5px; border: 1px solid #c7c6c6' class='button-hf' >
