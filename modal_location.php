...
<div id="location" class="modal fade" style="margin-top: 25px;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2">
		<div class="modal-dialog" role="document">
				<div class="modal-content">
						<div class="modal-header">
						        <!---<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>-->
						        <h4 class="modal-title" id="myModalLabel2">
								<span style="font-weight:normal;"><?php  echo "Where We are"; ?> </span></h4>
			      		...
			      		<div class="modal-body">
							...
							<img style="width:100px" src="images/location.jpg"></div>		
			...
			?>
					...
					<tr style='border-bottom:1px dotted gray'>
							...
							<td>FT Technologies. LTD<br/>P.O.Box 38373, Dar es salaam, Tanzania
							</td>
					</tr>
					
					<tr style='border-bottom:1px dotted gray'>
							<th>Physical Address:&nbsp;&nbsp;</th>
							<td>Madela St, Mikocheni B<br/>Dar es salaam, Tanzania
							</td>
					</tr>
